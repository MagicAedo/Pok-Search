// To parse this data:
//
//   import { Convert, PokemonInterface } from "./file";
//
//   const pokemonInterface = Convert.toPokemonInterface(json);
//
...
export class Convert {
    public static toPokemonInterface(json: string): PokemonInterface {
        return cast(JSON.parse(json), r("PokemonInterface"));
    }

    public static pokemonInterfaceToJson(value: PokemonInterface): string {
        return JSON.stringify(uncast(value, r("PokemonInterface")), null, 2);
    }
}
